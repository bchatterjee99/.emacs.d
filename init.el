...
;; diary
(setq diary-file "/mnt/localdisk_d/__isi/diary")
(setq diary-number-of-entries 15)
...
(defun thikache ()
  ...
  (find-file "/mnt/localdisk_d/emacs-files/start.txt")
...
(load "/mnt/localdisk_d/emacs-files/files.el")
...
(custom-set-variables
 ...
 '(package-selected-packages
   '(lean-mode emms ess base16-theme helm expand-region modus-themes soothe-theme rainbow-delimiters nyan-mode malyon linum-relative key-chord gruvbox-theme fireplace evil-visual-mark-mode disable-mouse company aggressive-indent afternoon-theme))
 '(tool-bar-mode nil))
(custom-set-faces
 ...
 ;; Your init file should contain only one such instance.
 ;; If there is more than one, they won't work right.
 '(default ((t (:family "Ac437 IBM EGA 9x8" :slant normal :weight bold :height 95 :width normal)))))
